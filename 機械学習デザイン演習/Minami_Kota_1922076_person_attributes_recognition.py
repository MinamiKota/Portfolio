...
"""
 ...
 わかりやすい表現に変える課題のためk.minamiが編集(2020/07/06)
...
def main():
    ...
    while True:     
            ...
            if proposal[2] > 0:
                ...
                if proposal[2] > 0.5:
                    try:
                        ...
                        person_image = original_image[ymin:xmin, ymax:xmax]
        ...
        cv2.resizeWindow('result2',150,150)
        b_img=cv2.imread('black.png')
        ...
        if len(objects)>0:
            for box in objects[0]:
                ...
                if box[8][0] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "is male" ,(box[2]+5,box[1]+10), font, 0.5, color)
                cv2.putText(b_img, "is male" ,(10,40), font, 1, color)
                # has_bag
                if box[8][1] > 0.5:
                    color = (255, 0, 0)
                else:
                    color = (0,0,255)
                # cv2.putText(original_image, "has bag" ,(box[2]+5,box[1]+30), font, 0.5, color)
                cv2.putText(b_img, "has bag" ,(10,70), font, 1, color)
                ...
                if box[8][2] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "has backpack" ,(box[2]+5,box[1]+50), font, 0.5, color)
                cv2.putText(b_img, "has backpack" ,(10,100), font, 1, color)
                ...
                if box[8][3] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "has hat" ,(box[2]+5,box[1]+80), font, 0.5, color)
                cv2.putText(b_img, "has hat" ,(10,130), font, 1, color)
                ...
                if box[8][4] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "has longsleeves" ,(box[2]+5,box[1]+110), font, 0.5, color)
                cv2.putText(b_img, "has longsleeves" ,(10,160), font, 1, color)
                ...
                if box[8][5] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "has longpants" ,(box[2]+5,box[1]+140), font, 0.5, color)                
                cv2.putText(b_img, "has longpants" ,(10,190), font, 1, color)
                ...
                if box[8][6] > 0.5:
                    ...
                    color = (0,0,255)
                # cv2.putText(original_image, "has longhair" ,(box[2]+5,box[1]+170), font, 0.5, color)                
                cv2.putText(b_img, "has longhair" ,(10,220), font, 1, color)
                ...
                if box[8][7] > 0.5:
                    ...
                    color = (0,0,255)
                #cv2.putText(original_image, "has coat jacket" ,(box[2]+5,box[1]+200), font, 0.5, color)                
                cv2.putText(b_img, "has coat jacket" ,(10,250), font, 1, color)  
                
        cv2.imshow('result2', b_img)
